...
class ViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    private var dataArray: Array<String> = ["开屏广告","开屏广告2.0","信息流广告","Banner横幅广告","激励视频","插屏广告","Draw视频","全屏视频","内容组件","组合广告 GroupAd", "快手内容"]
...
//        setBtn.setTitle("设置", for: .normal)
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 0:
            ...
            break
        case 1:
            self.navigationController?.pushViewController(ADSuyiSplashProViewController.init(), animated: true)
            break
        case 2:
